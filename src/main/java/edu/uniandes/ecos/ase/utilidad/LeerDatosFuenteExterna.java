...
public class LeerDatosFuenteExterna {
     ...
     * @return Lista con los datos leídos de un archivo plano
     */
    public static List<String> leerArchivoPlanoSeparacionComa(String rutaArchivo) {
        String lineaLeida = null;
        List<String> listaDato = new ArrayList<String>();
        try {
            /*Se abre el archivo*/
            ...
            while ((lineaLeida = buffer.readLine()) != null) {
                ...
                Double coeficiente = Double.parseDouble(valores[0]) / Double.parseDouble(valores[1]);
                listaDato.add(coeficiente.toString());
            }
            //Se cierra el archivo
            entrada.close();
        } catch (Exception e) {
